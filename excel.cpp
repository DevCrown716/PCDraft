...
static LPUNKNOWN AFXAPI _QueryInterface(LPUNKNOWN lpUnknown, REFIID iid)
{
...
BOOL _Application::GetDispatch(LPCTSTR lpszProgID,COleException* pError)
{
	...
	m_lpDispatch = (LPDISPATCH)_QueryInterface(lpUnknown, IID_IDispatch);
...
Failed:
	...
	if (pError != NULL)
		pError->m_sc = sc;
	TRACE1("Warning: GetDispatch returning scode = %s.\n",
