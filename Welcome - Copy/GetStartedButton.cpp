...
void GetStartedButton::OnMButtonDblClk(UINT nFlags, CPoint point)
{
...
void GetStartedButton::OnLButtonDblClk(UINT nFlags, CPoint point)
{
   // TODO: Add your message handler code here and/or call default
...
void GetStartedButton::OnDraw(CDC * pdc, Gdiplus::Graphics * pgraphics)
{
...

   {
      ...
      rIcon.Width = 44 * size_scaler();

      rIcon.Height = 44 * size_scaler();
