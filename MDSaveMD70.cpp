...
int CMDAngularDim::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDAngularDim ps;
   ps.fID=::formatMD70::IDAngularDim;
   ctx.pPhShape=(PhMDFillShape*)&ps;
   CMDAssocDim::SaveMacDraft70(ctx);
...
int CMDArcShape::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   if(m_nMode == kElliptic)
   {
      PhMDArc ps;
      ps.cBackwards = 0;
      ps.fID=::formatMD70::IDEArc;
      ctx.pPhShape=&ps;
      CMDFillShape::SaveMacDraft70(ctx);

      ps.method=formatMD70::eEllipse;
      //ps.fDummy=0;
      ps.fCenter.fUse=0;
   ...
   else
   {
      PhMDArc ps;
      ps.cBackwards = 0;
      ps.fID=(m_nMode == kRadius)?::formatMD70::IDArc : ::formatMD70::ID3Arc;
      ctx.pPhShape=&ps;
      CMDFillShape::SaveMacDraft70(ctx);

      ps.method=(m_nMode == kRadius)?::formatMD70::eCenterRadius : ::formatMD70::e3Point;
      //ps.fDummy=0;
      ps.fCenter.fUse=0;
      ps.fCenter.fFlags=kPhRealVertex;
      ps.fCenter.fLongPt=GetCenter();
      ...
      case kRadius:
      {
         ps.StartPt.fLongPt = m_pt[m_nArcDirection == AD_CLOCKWISE ? 2 : 1];
         ps.StartPt.fUse=0;
         ps.StartPt.fFlags=kPhRealVertex;
         ps.EndPt.fLongPt = m_pt[m_nArcDirection == AD_CLOCKWISE ? 1 : 2];
         ps.EndPt.fUse=0;
         ps.EndPt.fFlags=kPhRealVertex;
         auto abeg = mtAngle(ps.fCenter.fLongPt, ps.StartPt.fLongPt);
         auto aend = mtAngle(ps.fCenter.fLongPt, ps.EndPt.fLongPt);
         while (aend < abeg)
         {
            aend += 360.0;
         }
         auto amid = (aend + abeg) / 2.0;
         ps.ThirdPt.fLongPt.x.m_d = ps.fCenter.fLongPt.x.m_d + ps.Radii.x.m_d * mtCos(amid);
         ps.ThirdPt.fLongPt.y.m_d = ps.fCenter.fLongPt.y.m_d + ps.Radii.y.m_d * mtSin(amid);
         ps.ThirdPt.fUse = 0;
         ps.ThirdPt.fFlags = 0;
      }
      break;
...
int CMDArea::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   {
      PhMDArea ps;
      ps.fID=::formatMD70::IDArea;
      ctx.pPhShape=(PhMDFillShape*)&ps;
      CMDFillShape::SaveMacDraft70(ctx);
...

   {
      ...
      //ps.fObjHdl=(unsigned __int64)this;
...
void CMDAssocDim::SaveMacDimLabel(::formatMD70::PhIOContext &ctx)
{
...
int CMDAssocDim::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   FillModel fm;
   ...
   // roundoff
   ps->cShapeFlags&=0xF0FF;
   ps->cShapeFlags|=((m_DimFmt.nRoundoff & 0xF) << 8);
...
int CMDBezierShape::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   ...
   for(int i=0;i<m_nCount;i++)
   {
      ...
      shape.data.Add(DDBPoint(m_pt[i], flags, i==0));
...
int CMDBitmap::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDBitmap ps;
   ps.fID=::formatMD70::IDBitmap;
   ctx.pPhShape=&ps;
   CMDFillShape::SaveMacDraft70(ctx);
...
int CMDCenterDim::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDCenterDim ps;
   ps.fID=::formatMD70::IDCenterDim;
   ctx.pPhShape=(PhMDFillShape*)&ps;
   CMDAssocDim::SaveMacDraft70(ctx);
...
int CMDCircle::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDCircle ps;
   ps.fID=::formatMD70::IDCircle;
   ctx.pPhShape=&ps;
   CMDFillShape::SaveMacDraft70(ctx);
   ...
   case kRadius:
      ps.data.SetSize(2);
      ps.method=::formatMD70::eCenterRadius;
   ...
   case kDiameter:
      ps.data.SetSize(3);
      ps.method=::formatMD70::eDiameter;
      ps.data[0].fFlags=kPhRealVertex;
      ps.data[0].fLongPt=GetCenter();
      ps.data[0].fUse=0;
      ps.data[1].fFlags=kPhRealVertex;
...
int CMDCubicShape::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
...
int CMDDimLine::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDDim ps;
   ps.fID=::formatMD70::IDDimPt2Pt;
   ctx.pPhShape=(PhMDFillShape*)&ps;
   CMDShape::SaveMacDraft70(ctx);
   ...
   ps.cDimStrHdl=(unsigned __int64)m_pAttached;
...
int CMDDimStr::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDDimStr ps;
   ps.fID=::formatMD70::IDDimString;
   ctx.pPhShape=(PhMDFillShape*)&ps;
   ...
   ps.cObjHdl= (unsigned __int64)m_pOwner;
   ps.str = m_sValue;
...
int CMDEllipse::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDEllipse ps;
   ps.fID=::formatMD70::IDEllipse;
   ctx.pPhShape=&ps;
   CMDFillShape::SaveMacDraft70(ctx);
   ...
   ps.method=(m_nType == kRectCenter)?::formatMD70::eCenterRadius:  ::formatMD70::eDiameter;
   //ps.fDummy=0;
   ps.fCenter.fUse=0;
   ps.fCenter.fFlags=kPhRealVertex;
   ps.fCenter.fLongPt=GetCenter();
...
int CMDFillShape::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   CMDShape::SaveMacDraft70(ctx);
...
int CMDGroupShape::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   ...
   while(pos)
   {
      ...
      pointers.Add((unsigned __int64)pShape);

      bWall = bWall && pShape->IsKindOf(RUNTIME_CLASS(CMDParallelPolygon));
   ...
   if(bWall)
   {
      ...
      ps.fID=::formatMD70::IDWall;

      ctx.pPhShape= (PhMDShape *)&ps;

      CMDShape::SaveMacDraft70(ctx);

      if(pointers.GetCount() > 0)
      {
         ...
         while(pos)
         {
            ...
            CMDParallelPolygon * ppolygon = (CMDParallelPolygon *)pShape;

            int iLast = -1;

            for(int i = 0; i < ppolygon->GetNumShapePoints(); i++)
            {
               ...
               p.fLongPt.reservedForZ = 0;

               p.fLongPt = ppolygon->GetShapePoint(i);

               p.fFlags = kPhRealVertex;

               p.fUse = iNode == 0 && pos == NULL && ppolygon->GetNumShapePoints() == 2 ? 1: 0;

               p.fReserved1 = 0;
               
               int iFind = -1;

               for(int iN = 0; iN < ps.data.GetCount(); iN++)
               {

                  if(p.fLongPt.x == ps.data[iN].fLongPt.x && p.fLongPt.y == ps.data[iN].fLongPt.y)
                  {
               ...
               if(i > 0)
               {
                  ...
                  ps.segments.Add(CPoint(iLast,iFind ));
            ...
            if(ppolygon->IsClosed())
            {
               ...
               ps.segments.Add(CPoint(iLast,0));

            }

            ctx.ConvertParaAttr(ppolygon->GetParallelAttrs(),ps.fParallelAttr);

            if(bFirst)
            {

               ppolygon->CMDFillShape::SaveMacDraft70(ctx);
         ...
         ps.pointsCount = ps.data.GetCount();


         ps.segmentsCount = ps.segments.GetCount();
   ...
   else
   {
      ...
      if(pointers.GetCount() > 0)
      {
         ...
         ps.itemsCount = pointers.GetCount();

         ps.pointers.Append(pointers);
         ...
         while(pos)
         {
            ...
            iCount += pShape->SaveMacDraft70(ctx);
...
int CMDLineDim::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDLineDim ps;
   switch(m_nType)
   {
   case kHoriz:
      ps.fID=::formatMD70::IDHLineDim;
      break;
   case kVert:
      ps.fID=::formatMD70::IDVLineDim;
      break;
   case kSlope:
      ps.fID=::formatMD70::IDSLineDim;
      break;
   case kPerp:
      ps.fID=::formatMD70::IDPLineDim;
      break;
   }
   ctx.pPhShape=(PhMDFillShape*)&ps;
   ::formatMD70::Angle savedAngle=m_RotAngle.GetRawDouble() / 65536.0;
   m_RotAngle=m_Angle;
...
int CMDLineShape::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDLine ps;
   ps.fID=::formatMD70::IDLine;
   ctx.pPhShape=(PhMDFillShape*)&ps;
   CMDShape::SaveMacDraft70(ctx);
   ...
   ps.fP1.fFlags=kPhRealVertex;
   ps.fP1.fLongPt=m_pt[0];
   ps.fP1.fUse=ctx.pGroup && ctx.pGroup->IsKindOf(RUNTIME_CLASS(CMDMetaPolyShape)) ? 1 : 0;
   ps.fP2.fFlags=kPhRealVertex;
   ps.fP2.fLongPt=m_pt[1];
   ps.fP2.fUse=0;
   ...
   //::formatMD70::ushort count=sizeof(PhMDLine) << 8;	// swapped
   //ctx.f->Write(&count,sizeof(short));
...
int CMDMetaPolyShape::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   ...
   CArray < CBezierEdge * > array;

   while(pos || array.GetCount() > 0)
   {
      ...
      if(pos)
      {
         ...
         pEdge = m_Edges.GetNext(pos);

      }

      CMDShape* pShape= NULL;

      if(array.GetCount() > 0 && (pEdge == NULL || pEdge->m_nType != CEdge::kBezierEdge || pEdge->m_iBezierIndex == 0))
      {

         int iCount = array.GetCount() * 3 + 1;

         auto pBezierShape = new CMDBezierShape(iCount);
         ...
         for(j = 0; j < array.GetCount(); j++)
         {
            ...
            pBezierShape->SetShapePoint(j * 3+0,p->m_lptFrom);
            
            pBezierShape->SetShapePoint(j * 3 + 1,p->m_lptFromCtl);
         
            pBezierShape->SetShapePoint(j * 3 + 2,p->m_lptToCtl);

            if(j < array.GetUpperBound())
            {

               if(!guAlmostEqualPt(p->m_lptTo,array[j + 1]->m_lptFrom))
               {

                  OutputDebugString("Disjoint Bezier");
         ...
         pBezierShape->SetShapePoint(j * 3,p->m_lptTo);

         pBezierShape->SetPenModel(m_PenModel);

         pBezierShape->CalculateExtents();

         pBezierShape->SetShapeDatum(kDefaultDatum);

         pShape = pBezierShape;

         shapea.Add(pShape);

         ctx.metaMembers.Add((unsigned __int64)pShape);
      ...
      if(pEdge)
      {
         ...
         if(pEdge->m_nType == CEdge::kBezierEdge)
         {
            ...
            CBezierEdge * pBezierEdge = (CBezierEdge *)pEdge;
            
            array.Add(pBezierEdge);

         }
         else
         {

            pShape = pEdge->CreateShape();
   ...
   if(shapea.GetCount() > 0)
   {
      ...
      for(int i = 0; i < shapea.GetCount(); i++)
      {
         ...
         metaCount += pshape->SaveMacDraft70(ctx);
...
int CMDParallelLine::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   ...
   for(int i = 0; i < GetNumShapePoints(); i++)
   {
      ...
      p.fLongPt = GetShapePoint(i);

      p.fFlags = kPhRealVertex;

      p.fUse = iNode == 0 && GetNumShapePoints() == 2 ? 1: 0;
   ...
   ctx.ConvertParaAttr(GetParallelAttrs(),ps.fParallelAttr);

   CMDShape::SaveMacDraft70(ctx);

   ctx.ConvertFillModel(m_Attrs.m_Fill, ps.cFillModel);
   ps.cFillShapeReserved = 0;
   ps.cFillShapeReserved1 = 0;
   ps.cFillShapeReserved2 = 0;
...
int CMDParallelPolygon::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDWall ps;
   ...
   for(int i = 0; i < iCount; i++)
   {
      ...
      p.fUse = !m_bClosed && iNode == 0 && GetNumShapePoints() == 2 ? 1: 0;
...
int CMDPolygonShape::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   short phID;
   if(m_nType<=kFreeSpline)
   {
      phID=m_nType == kFreehand?::formatMD70::IDFreehand : ::formatMD70::IDPolygon;
      PhMDPolygon ps;
      //ps.vertexCount = m_nCount - 1;
//      int size=sizeof(PhMDPolygon) + sizeof(PhDBPoint)*(m_nCount - 1);
      //PhMDPolygon* ps=(PhMDPolygon*)malloc(size);
      ps.fID=(::formatMD70::eID) phID;
      ctx.pPhShape=&ps;
      CMDFillShape::SaveMacDraft70(ctx);
...
//      free(ps);
   ...
   else
   {
      ...
      {
      case kFreeSpline:
         phID=::formatMD70::IDFreeSpline;
         break;
      case kPolySpline:
         phID=::formatMD70::IDPolySpline;
         break;
      default:
         return 0;
      }
...
int CMDRadialDim::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDLineDim ps;
   ps.fID=m_bDiameter?::formatMD70::IDDRadialDim : ::formatMD70::IDRRadialDim;
   ctx.pPhShape=(PhMDFillShape*)&ps;
...
int CMDRectangle::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDRectangle ps;
   ps.fID=(m_nType == kRectCenter)?::formatMD70::IDRectCenter: ::formatMD70::IDRectDiagonal;
   ctx.pPhShape=&ps;
   CMDFillShape::SaveMacDraft70(ctx);
...
void CMDShape::SaveMacObjInfo(::formatMD70::PhIOContext& ctx)
{
   ...
   if(ctx.pPhShape->fID == ::formatMD70::IDMetaPoly)
   {
   ...
   else if(ctx.pPhShape->fID == ::formatMD70::IDGroup)
   {
   ...
   short count;
   if(ctx.pPhShape->the64ObjectInfo)
   {
      PhObjectInfo pInfo;
      pInfo.fVersion=1;
      pInfo.fSetNumber=1;
...
//      ctx.serialize(&pInfo);
   ...
   if(ctx.pPhShape->cRef || ctx.nCount || ctx.pPhShape->theLong == 0 || ctx.pPhShape->theLong == 1 || m_pAttached)
   {
      ...
      if(propCount)
      {
         for(UInt64 ui = 0; ui < propCount; ui++)
         {
            ...
            }
            {
               ...
               ctx.serialize(a.fFlags);
               ctx.serialize(a.fDataLength);
               ctx.serialize(a.fArea);
               ctx.serialize(a.fPerimeter);
               ctx.serialize(a.fReserved2);
...
int CMDRndRectangle::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   PhMDRndRectangle ps;
   ps.fID=::formatMD70::IDRndRectangle;
   ctx.pPhShape=&ps;
   CMDFillShape::SaveMacDraft70(ctx);
   ...
   case kCornerProportional:
      ps.cCornerType=::formatMD70::kProportionalCorner;
      break;
   case kCornerCircle:
      ps.cCornerType=::formatMD70::kConstantCorner;
      break;
   case kCornerElliptical:
      ps.cCornerType=::formatMD70::kEllipticalCorner;
      break;
   }
   ps.cDiagonals.fFlags=0;
   //ps.cDiagonals.fLongPt=m_lptCornerDelta << 1;
   ps.cDiagonals.fLongPt.x=m_lptCornerDelta.x*2;
   ps.cDiagonals.fLongPt.y=m_lptCornerDelta.y*2;
...
int CMDShape::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   ctx.pPhShape->the64=(unsigned __int64)this;
   ctx.pPhShape->cOwnerGroup= (unsigned __int64)ctx.pGroup;
   ctx.pPhShape->cShapeFlags=0;
   ctx.pPhShape->theAngle=m_RotAngle.GetRawDouble() / (65536.0);
   ctx.pPhShape->cRef=(m_pAttached && m_pAttached->IsKindOf(RUNTIME_CLASS(CMDArea)))?1:0;
   ctx.pPhShape->theLong = 0;
   ctx.ConvertPenModel(m_PenModel,ctx.pPhShape->cPenModel);
   if(m_PenModel.m_nAccurateWidth) ctx.pPhShape->cShapeFlags|=kPhAccurateWidthFlag;
   if(m_PenModel.m_nSquareEnds) ctx.pPhShape->cShapeFlags|=kPhSquareEndsFlag;

   ctx.pPhShape->cDatum=m_lptDatum;
   switch(m_nDatum)
   {
   case kFreeDatum:
      ctx.pPhShape->cShapeFlags|=kPhFreeDatumCodeMask;
      break;
   case kCenterDatum:
      ctx.pPhShape->cShapeFlags|=kPhCtrDatumCodeMask;
      break;
   }
   if(m_bLocked) ctx.pPhShape->cShapeFlags|=kPhObjLockedMask;
   if(ctx.pGroup && ctx.pGroup->IsKindOf(RUNTIME_CLASS(CMDMetaPolyShape))) ctx.pPhShape->cShapeFlags|=kPhMetaPolyMemberMask;
   ctx.pPhShape->the64ObjectInfo=(m_sValues[0].IsEmpty() && m_sValues[1].IsEmpty() && m_sValues[2].IsEmpty() && m_sValues[3].IsEmpty() && m_sValues[4].IsEmpty())?0:1;
...
int CMDText::SaveMacDraft70(::formatMD70::PhIOContext& ctx)
{
   ...
   //{
   //case ::kSingleSpace:
   //   ps.cTextSpace=(formatMD70::kSingleSpace) ;
   //   break;
   //case ::k1_5Space:
   //   ps.cTextSpace=(formatMD70::kOne_halfSpace) ;
   //   break;
   //case ::kDoubleSpace:
   //   ps.cTextSpace=(formatMD70::kDoubleSpace);
   //   break;
   //}
   ////ps.fDummy=0;
   ...
   //   break;
   //case kAlignMiddle:
   //   ps.cShapeFlags|=(1 << kPhVertTextAlignCodeShift);
   //   break;
   //case kAlignBottom:
   //   ps.cShapeFlags|=(2 << kPhVertTextAlignCodeShift);
   //   break;
   //}
   //
   ...
   //   m_StyledText.GetNextTextPart(pos,text,s,bLineFeed);
   ...
   CPalette * pPalette = ctx.pPalette;
   {

      ::text_format_rtf::std_output output(str);

      ::text_format_rtf::writer writer(&output);

      {
         ...
         bool bLineFeed ;
         int nStyleCount = 0;
         while(pos < textLen && pos >= 0)
         {
            nStyleCount++;
            //ste.scrpStartChar=pos;
            m_StyledText.GetNextTextPart(pos,text,theTextPlus1, s,bLineFeed);

            //CStringW wstr = get_uni(s.m_LogFont.lfFaceName, 932);
            //CStringW wstr1 = get_uni(s.m_LogFont.lfFaceName, 942);
            //CStringW wstr3 = get_uni(s.m_LogFont.lfFaceName, 943);
            //CStringW wstr4 = get_uni(s.m_LogFont.lfFaceName, 1393);
            writer.add_font(s.m_LogFont.lfFaceName, s.m_LogFont.lfCharSet);

            auto color = s.m_TextColor;
            if((color & 0xff000000) != 0)
            {
               UINT idx =color & 0x00ffffff;
               PALETTEENTRY pe;
...

      {
         ...
         while(pos < textLen && pos >= 0)
         {
            ...
            auto pformat = writer.get_paragraphformat();
            if(writer.fontid(s.m_LogFont.lfFaceName) != iFontNumber)
            {
               iFontNumber=writer.fontid(s.m_LogFont.lfFaceName);
            }
            pformat->CHARACTER.fontNumber = iFontNumber;
            pformat->CHARACTER.boldCharacter = s.m_LogFont.lfWeight > 400;
            pformat->CHARACTER.italicCharacter = s.m_LogFont.lfItalic;
            pformat->CHARACTER.underlineCharacter = s.m_LogFont.lfUnderline;
            HDC hDC=GetDC(NULL);
            int i = MulDiv(-s.m_LogFont.lfHeight,72,96) * 2;
            ...
            pformat->CHARACTER.fontSize=iFontSize;
            ReleaseDC(NULL,hDC);
            ...
            pformat->CHARACTER.foregroundColor =cr;

            writer.start_paragraph(text,bNewPar);
            bNewPar = bLineFeed;
         }
   ...
   ps.textDataSize = str.str().length();
   ps.m_strRtf = str.str().c_str();
