...
BEGIN_MESSAGE_MAP(TemplateStatic, BaseControl)
   ON_WM_LBUTTONUP()
   ON_WM_MBUTTONDBLCLK()
   ON_WM_LBUTTONDBLCLK()
   ON_WM_CREATE()
...
void TemplateStatic::OnLButtonUp(UINT nFlags, CPoint point)
{
...
void TemplateStatic::OnMButtonDblClk(UINT nFlags, CPoint point)
{
...
void TemplateStatic::OnLButtonDblClk(UINT nFlags, CPoint point)
{
...
int TemplateStatic::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void TemplateStatic::OnSize(UINT nType, int cx, int cy)
{
...
void TemplateStatic::OnDraw(CDC * pdc, Gdiplus::Graphics * pgraphics)
{
