...
void TemplateWnd::layout()
{
   ...
   m_iLeftWindow = 150 * size_scaler();
   m_yMainClient = 80 * size_scaler();
   ...
   m_categorywnd.SetWindowPos(nullptr, m_iLeftWindow + 1, m_yMainClient, cx - m_iLeftWindow - 1, cy - m_yMainClient - 16 * size_scaler(), m_escreen == e_screen_templates ? SWP_SHOWWINDOW : SWP_HIDEWINDOW);

   m_recentwnd.SetWindowPos(nullptr, m_iLeftWindow + 1, m_yMainClient, cx - m_iLeftWindow - 1, cy - m_yMainClient - 16 * size_scaler(), m_escreen == e_screen_recent_documents ? SWP_SHOWWINDOW : SWP_HIDEWINDOW);

   m_searchedit.SetWindowPos(nullptr, m_iLeftWindow + 350 * size_scaler(), 40 *size_scaler(), cx - m_iLeftWindow - (350 + 30) * size_scaler(), 16 * size_scaler(), SWP_SHOWWINDOW);

   m_staticCategories.SetWindowPos(nullptr, m_iLeftWindow + 18 * size_scaler(), 35 * size_scaler(), 70 * size_scaler(), 26 * size_scaler(), m_escreen == e_screen_templates ? SWP_SHOWWINDOW : SWP_HIDEWINDOW);

   m_combobox.SetWindowPos(nullptr, m_iLeftWindow + 90 * size_scaler(), 38 * size_scaler(), 140 * size_scaler(), 20 * size_scaler(), m_escreen == e_screen_templates ? SWP_SHOWWINDOW : SWP_HIDEWINDOW);
...
BOOL TemplateWnd::Create()
{
   ...
   rect.left = 0;
   rect.top = 0;
   rect.right = 1000 * m_dSizeScaler;
   rect.bottom = 620 * m_dSizeScaler;
