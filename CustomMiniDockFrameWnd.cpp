...
UINT UM_MAXIMIZE_CLICK = RegisterWindowMessage("UM_MAXIMIZE_CLICK");

/////////////////////////////////////////////////////////////////////////////
// CCustomMiniDockFrameWnd

IMPLEMENT_DYNCREATE(CCustomMiniDockFrameWnd, CMiniDockFrameWnd)

CCustomMiniDockFrameWnd::CCustomMiniDockFrameWnd()
{
...
BEGIN_MESSAGE_MAP(CCustomMiniDockFrameWnd, CMiniDockFrameWnd)
	//{{AFX_MSG_MAP(CCustomMiniDockFrameWnd)
	//ON_WM_NCPAINT()
	ON_WM_NCACTIVATE()
	ON_WM_NCLBUTTONDOWN()
	ON_WM_MOUSEMOVE()
...
/////////////////////////////////////////////////////////////////////////////
// CCustomMiniDockFrameWnd message handlers

// Interface Upgrade - Infinisys Ltd.
void CCustomMiniDockFrameWnd::OnPaint() // Interface Update - Infinisys Ltd.
{
...
//void CCustomMiniDockFrameWnd::OnNcPaint() 
//{
//	CMiniDockFrameWnd::OnNcPaint();
//	DrawButton();
//}

BOOL CCustomMiniDockFrameWnd::OnNcActivate(BOOL bActive) 
{
...
void CCustomMiniDockFrameWnd::DrawButton()
{
...
void CCustomMiniDockFrameWnd::CalcButtonRect(CRect& rc)
{
...
void CCustomMiniDockFrameWnd::SetMaximized(bool bMaximized)
{
...
bool CCustomMiniDockFrameWnd::is_narrow_window()
{
...
void CCustomMiniDockFrameWnd::InvertMaximized()
{
...
void CCustomMiniDockFrameWnd::OnNcLButtonDown(UINT nHitTest, CPoint point) 
{
...
void CCustomMiniDockFrameWnd::OnMouseMove(UINT nFlags, CPoint point) 
{
    // Blinking fix/Drag Trail Fix - Infinisys Ltd.
	//if(m_bTracking)
	//{
...
void CCustomMiniDockFrameWnd::OnLButtonUp(UINT nFlags, CPoint point) 
{
    // Blinking fix/Drag Trail Fix - Infinisys Ltd.
	//if(m_bTracking)
	//{
...
void CCustomMiniDockFrameWnd::ShowMaximizeBox(bool bShowMaximizeBox)
{
...
// Interface Update - Infinisys Ltd.
void CCustomMiniDockFrameWnd::OnActivate(UINT nState,CWnd* pWndOther,BOOL bMinimized)
{
...
LRESULT CCustomMiniDockFrameWnd::OnDwm(WPARAM wparam,LPARAM lparam)
{
   //return Default();
   BOOL enabled = FALSE;
...
void CCustomMiniDockFrameWnd::OnNcCalcSize(BOOL bCalcValidRects,NCCALCSIZE_PARAMS* lpncsp)
{
...
// Interface Update - Infinisys Ltd.
void CCustomMiniDockFrameWnd::RecalcLayout(BOOL bNotify)
{
...
int CCustomMiniDockFrameWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CCustomMiniDockFrameWnd::OnLButtonDown(UINT nFlags,CPoint point)
{
   ...
   CMiniDockFrameWnd::OnLButtonDown(nFlags,point);
}


BOOL CCustomMiniDockFrameWnd::PreCreateWindow(CREATESTRUCT& cs)
{
