...
#define kMarkerStringsStorage		kMarkerStartStructs + 96
#define kMarkerQuickLookPreview	kMarkerStartStructs + 104
#define kMarkerFontInUseInfo		kMarkerStartStructs + 112
...
#define kDashCodeEntryCount	16
   ...
   struct PhTextParams
   {
      ...
      Style	fTextStyle	;
      char	fReserved1	;
      short	fHorizTextJust	;
      TVertTextAlign	fVertTextAlign	;
      TTextFlipped	fTextFlip	;
      enum TSpace	fTextSpace	;
      enum TCase	fTextCase	;
      Boolean	fInPixels	;
      char	fReserved2	;
      short	fReserved3	;
      RGBColor	fTextColor	;
   ...
   struct PhChamferAttr
   {
      Coord	fLine1SetBack	;
      Coord	fLine2SetBack	;
      enum TrimMethod	fTrimMethod	;
   };
   struct PhFilletAttr
   {
      Coord	fRadius	;
      TrimMethod	fTrimMethod	;
   ...
   struct PhBitmapIOStruct
   {
      ...
      NonColorBitmap m_ncbitmap;
      ColorBitmap m_bitmap;
...
#define kPhPrintPlot		0x0008
   ...
   struct PhActiveEnvirons
   {
      ...
      CoordPoint	fRulerOrigin	;
      DmPrintFlags	fPrintFlags	;
      short	fAngleSnapsToACircle	;
      short	fDimTextAlgn	;
      char	fDashMenuItem	;
      Boolean  fHasGrid;
      Boolean	fHideText	;
      ...
      SInt16	fColorUsageSettings	;
      SInt16	fReserved02	;
      Boolean	fPrintWithBGColor	;
      Boolean	fShowGuides	;
      Boolean	fSmartSnap	;
      Boolean	fSnapToGuides	;
      char	fDimEndCap_1	;
      char	fDimEndCap_2	;
      SInt16	fDimType_2	;
   ...
   struct PhMDShape: public serializable
   {
      ...
      ulong	         cShapeReserved2 = 0;
      ulong	         cShapeReserved3 = 0;
...
#define	kPhDummy1				128
   ...
   public:
      ...
      void write(OFFSET & offset,LENGTH & length, CFile * pfileSrc)
      {
         ...
         pfileSrc->Read(mem.m_pdata,(UINT) mem.m_iSize);

         offset = (OFFSET) m_pfile->GetPosition();

         length = (LENGTH) mem.m_iSize;

         m_pfile->Write(mem.m_pdata,(UINT) mem.m_iSize);
